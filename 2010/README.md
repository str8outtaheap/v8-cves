...
| --- | --- | --- | --- | --- | --- |
| CVE-2010-1506 | [40635](https://issues.chromium.org/issues/40635) | The Google V8 bindings in Google Chrome before 4.1.249.1059 allow attackers to cause a denial of service (memory corruption) via unknown vectors. | no | — | [Chrome 4.1.249.1059](https://chromereleases.googleblog.com/2010/04/stable-update-security-fixes.html) |
